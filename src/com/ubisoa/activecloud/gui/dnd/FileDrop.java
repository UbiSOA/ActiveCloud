package com.ubisoa.activecloud.gui.dnd;
...
import com.ubisoa.activecloud.gui.LineSquarePanel;
            ...
            {   public void dragEnter( java.awt.dnd.DropTargetDragEvent evt )
                {       log( out, "FileDrop: dragEnter event." );
                    ...
                    if( isDragOk( out, evt ) )
                    {
                        ...
                        if(c instanceof LineSquarePanel){
                        	LineSquarePanel lsp = (LineSquarePanel)c;
                        	lsp.paintOk();
                        }
